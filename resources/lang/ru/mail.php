...
в ваш веб-браузер: [:actionURL](:actionURL)',
    ...
    'post_republished_title' => 'Ваше объявление было повторно опубликовано',
    'post_republished_content_1' => 'Привет,',
    'post_republished_content_2' => 'Ваше объявление <a href=":postUrl">:title</a> было успешно опубликовано повторно.',
    'post_republished_content_3' => 'Вы получили это письмо, потому что недавно создали новое объявление в :appName. Если это не вы, не обращайте внимания на это письмо.',
...
<br><strong>Способ оплаты:</strong> :paymentMethodName',
    'payment_approved_title' => 'Ваш платеж был одобрен!',
    'payment_approved_content_1' => 'Привет,',
    'payment_approved_content_2' => 'Ваш платеж за рекламу "<a href=":postUrl">:title</a>" был одобрен.',
    'payment_approved_content_3' => 'Спасибо!',
    'payment_approved_content_4' => 'Детали платежа
<br><strong>Причина платежа:</strong> Реклама #:adId - :packageName
<br><strong>Сумма:</strong> :amount :currency
<br><strong>Платежный метод:</strong> :paymentMethodName',
    ...
    'generated_password_content_1' => 'Привет :userName!',
    'generated_password_content_2' => 'Ваш аккаунт был создан.',
    'generated_password_verify_content_3' => 'Нажмите кнопку ниже, чтобы подтвердить ваш адрес электронной почты.',
    'generated_password_verify_action' => 'Подтвердите адрес электронной почты',
    'generated_password_content_4' => 'Ваш пароль: <strong>:randomPassword</strong>',
    'generated_password_login_action' => 'Войти сейчас!',
    'generated_password_content_6' => 'Вы получили это письмо, потому что недавно создали новую учетную запись :appName или добавили новый адрес электронной почты. Если это не вы, не обращайте внимания на это письмо.',
];
