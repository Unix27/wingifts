...
class CategoryCrudController extends CrudController
{
    ...
    protected function setupListOperation()
    {
         ...
         */
         ...
         CRUD::column('slug');
         CRUD::column('is_active')->type('boolean')->label('Активная');
         CRUD::column('courses')->type('relationship_count')->label('Курсы')->suffix(' курсов');
    }
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::field('is_active')->type('boolean')->default(1)->label('Активна');
    }
