...
class FileCrudController extends CrudController
{
    ...
    protected function setupListOperation()
    {
        ...
        CRUD::column('path')->label('Путь');
		CRUD::column('course')->type('relationship')->label('Курс');     
    }
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::field('course_id')->type('select2')->entry('course')->model('App\Models\Course')->attribute('title')->label('Курс'); 
		//CRUD::field('course')->type('relationship'); 
        CRUD::field('path')->type('browse')->label('Файл');         
    }
